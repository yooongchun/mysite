...
class Icon(models.Model):
    """用户头像"""
    url = models.URLField(verbose_name="用户头像",
...
class User(AbstractUser):
    ...
    icon = models.ForeignKey(
        Icon, on_delete=models.SET_NULL, verbose_name='用户头像', blank=True, null=True)
...
class Category(models.Model):
    ...
    category = models.CharField(
        verbose_name='类别', max_length=10, unique=True, default='')
...
class InfoMsg(models.Model):
    """网站通知"""
    info = models.CharField(verbose_name='通知信息',
                            unique=True, default='', max_length=20)
...
class Collection(models.Model):
    ...
    collection = models.CharField(
        verbose_name='专栏', unique=True, default='', max_length=20)
...
class CollectionTag(models.Model):
    ...
    collection = models.ForeignKey(
        Collection, verbose_name='专栏名称', on_delete=models.CASCADE, default='')
...
class Blog(models.Model):
    ...
    title = models.CharField(
        verbose_name='标题', max_length=100, default='', unique=True)
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name='作者', default='')
    ...
    cover = models.ForeignKey(
        CoverImage, verbose_name='封面', on_delete=models.SET_NULL, null=True, blank=True)
    collection = models.ForeignKey(
        Collection, on_delete=models.SET_NULL, verbose_name='专栏', null=True, blank=True)
    collection_tag = models.ForeignKey(CollectionTag, on_delete=models.SET_NULL, verbose_name='专栏标签', null=True,
                                       blank=True)
    render_with_markdown = models.BooleanField(
        verbose_name='Markdown渲染', default=True)
...
class Visitor(models.Model):
    ...
    coordination = models.CharField(
        verbose_name='经纬度', default='', max_length=50)
...
class Comment(models.Model):
    ...
    content = models.TextField(
        verbose_name='评论内容', default='', max_length=1000)
    ...
    parent = models.ForeignKey(
        'self', verbose_name='父评论', on_delete=models.CASCADE, null=True, blank=True)
    display = models.BooleanField(verbose_name='是否展示', default=True)
...
class Message(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name='用户', default='')
    ...
    reply_content = models.TextField(
        verbose_name='留言回复', default='', max_length=500)
...
class Resource(models.Model):
    ...
    password = models.CharField(
        verbose_name='访问密码', default='0', max_length=128)
    ...
    cover = models.ForeignKey(
        CoverImage, verbose_name='图片', null=True, blank=True, on_delete=models.SET_NULL)
    display = models.BooleanField(verbose_name='是否展示', default=True)
...
class FriendLink(models.Model):
    ...
    description = models.CharField(
        verbose_name='描述信息', default='', max_length=100)
...
class PhotographyImageList(models.Model):
    ...
    description = models.TextField(
        verbose_name='描述', default='', max_length=200)
...
class ArchiveFolder(models.Model):
    ...
    archive_name = models.CharField(
        verbose_name='归档', default='', max_length=50)
...
class CZDataDownloadList(models.Model):
    ...
    download_date = models.DateTimeField(
        verbose_name="下载时间", default=datetime.now)
